...
//////////////////////////////////////// MySQL  ////////////
		...
		void connectDB();
		void updateDB(int id, std::string spotName, int roi_x, int roi_y, int roi_h, int roi_w, int policy);
		bool isExist(int id);
		void createDB(int id, std::string spotName, int roi_x, int roi_y, int roi_h, int roi_w, int policy);
		void pullDB();
